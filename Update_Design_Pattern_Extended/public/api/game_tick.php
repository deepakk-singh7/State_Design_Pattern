...
if (!isset($_SESSION['world'])) {
    ...
    $world->addEntity(new Spawner(5, 5, 8)); // Will spawn minions
...
// Process one game frame (tick). All entity updates and interactions happen here.
// The tick() method returns an array of data[entitites].
$entitiesData = $world->tick(); 
