...
abstract class Entity
{
    ...
    /**
     * X velocity of the entity (units per second)
     * @var float
     */
    protected float $vx = 0.0;

    /**
     * Y velocity of the entity (units per second)
     * @var float
     */
     ...
     * @param float $deltaTime The time elapsed since the last update, in seconds
     * @return void
     */
    ...
    public function getState(): array
    {
        return [
            ...
            'x' => $this->x,
            'y' => $this->y,
            'vx' => $this->vx, // Velocity X for client extrapolation
            'vy' => $this->vy  // Velocity Y for client extrapolation
        ];
    }
}