...
// The main Game class.
// This object is responsible for managing the main game loop and all game objects.
...
class Game {
     ...
     * @param int $frameTimeMs The simulated time it takes to process and render one frame. as it depends on the hardware.
     */
    public function run(int $simulationTimeMs, int $frameTimeMs): void {
        ...
        while ($totalTimeSimulated < $simulationTimeMs) {
            ...
            // After catching up, it calls the render method on game objects.
            $this->car->render();
