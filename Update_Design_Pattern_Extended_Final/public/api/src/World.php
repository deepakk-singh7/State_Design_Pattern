 ...
 * Processes a single frame/tick of the game loop.
    * @param float $deltaTime The time elapsed since the last tick, in seconds.
    * @return array The state of all entities, ready for JSON encoding.
    */
    public function tick(float $deltaTime): array
    {
        // 1. Update each entity, passing deltaTime to them.
        foreach ($this->entities as $entity) {
            $entity->update($this, $deltaTime);
        }
        
        // ... (the rest of the method: handleCollisions, applyRemovals, etc. remains the same) ...
        
        // 2. Handle collisions after all entities have moved.
